...
-- Clear existing events and repopulate with enhanced data
...
-- Insert enhanced speakers with more detailed information
...
-- Physical AI Breakfast
(13, 'Dr. Sarah Chen', 'Founding Partner', 'Schematic Ventures', 'host', 'Former Tesla Autopilot engineer, robotics and AI investment specialist'),
(13, 'Marcus Rodriguez', 'CTO', 'Boston Dynamics AI', 'speaker', 'Leading embodied AI and robotic intelligence research'),

-- Enterprise AI Breakfast Featured Startups
(12, 'Alex Kumar', 'CEO', 'Finnt AI', 'presenter', 'Enterprise financial intelligence platform using multimodal AI'),
(12, 'Lisa Zhang', 'Founder', 'Sotira Health', 'presenter', 'AI-powered healthcare analytics for enterprise health systems'),
(12, 'David Park', 'CEO', 'Phronetic AI', 'presenter', 'Ethical AI decision-making platform for enterprise risk management'),

-- Capital Markets Panel
(11, 'Jennifer Walsh', 'Partner', 'PwC Digital Assets', 'moderator', 'Leading AI company financial strategy and valuation'),
(11, 'Robert Kim', 'MD', 'Silicon Valley Bank AI Practice', 'panelist', 'Banking and finance for AI startups and growth companies'),

-- Nordic Innovation Conference
(10, 'Ben Horowitz', 'Co-founder', 'a16z', 'keynote', 'Legendary VC hosting Nordic founders lunch, AI investment pioneer'),
(10, 'Lars Anderson', 'Partner', 'Creandum', 'panelist', 'Leading Nordic VC with focus on AI and climate tech investments'),
(10, 'Maria Eriksson', 'CEO', 'Nordic AI Alliance', 'moderator', 'Connecting Nordic AI ecosystem with global markets');

-- Map events to enhanced categories with specific technical focuses
INSERT INTO event_category_mappings (event_id, category_id) VALUES

-- AI Infrastructure Event (1) - multiple AI categories
(1, (SELECT id FROM event_categories WHERE name = 'Generative AI')),
(1, (SELECT id FROM event_categories WHERE name = 'Multimodal AI')),
(1, (SELECT id FROM event_categories WHERE name = 'AI Infrastructure')),
(1, (SELECT id FROM event_categories WHERE name = 'MLOps')),

-- Anthropic Salon (2) - Advanced AI Research
(2, (SELECT id FROM event_categories WHERE name = 'Enterprise AI')),
(2, (SELECT id FROM event_categories WHERE name = 'Natural Language Processing')),
(2, (SELECT id FROM event_categories WHERE name = 'AI Ethics')),

-- Wellness Run (3) - Leadership & HR
(3, (SELECT id FROM event_categories WHERE name = 'Wellness')),
(3, (SELECT id FROM event_categories WHERE name = 'HR Tech')),

-- Pitch Competition (4) - Multiple AI verticals
(4, (SELECT id FROM event_categories WHERE name = 'Venture Capital')),
(4, (SELECT id FROM event_categories WHERE name = 'Generative AI')),
(4, (SELECT id FROM event_categories WHERE name = 'Computer Vision')),
(4, (SELECT id FROM event_categories WHERE name = 'Robotics')),

-- Fintech Innovation (5)
(5, (SELECT id FROM event_categories WHERE name = 'Fintech AI')),
(5, (SELECT id FROM event_categories WHERE name = 'Developer Tools')),

-- Legal & Policy (6)
(6, (SELECT id FROM event_categories WHERE name = 'Legal Tech')),
(6, (SELECT id FROM event_categories WHERE name = 'AI Ethics')),
(6, (SELECT id FROM event_categories WHERE name = 'Enterprise AI')),

-- Cybersecurity (7)
(7, (SELECT id FROM event_categories WHERE name = 'Cybersecurity AI')),
(7, (SELECT id FROM event_categories WHERE name = 'Enterprise AI')),

-- Quantum Computing (8)
(8, (SELECT id FROM event_categories WHERE name = 'Quantum Computing')),
(8, (SELECT id FROM event_categories WHERE name = 'AI Infrastructure')),

-- Developer Tools (9)
(9, (SELECT id FROM event_categories WHERE name = 'Developer Tools')),
(9, (SELECT id FROM event_categories WHERE name = 'DevOps')),

-- Nordic Conference (10) - International & Climate
(10, (SELECT id FROM event_categories WHERE name = 'Venture Capital')),
(10, (SELECT id FROM event_categories WHERE name = 'Climate Tech')),

-- Capital Markets (11)
(11, (SELECT id FROM event_categories WHERE name = 'Fintech AI')),
(11, (SELECT id FROM event_categories WHERE name = 'Venture Capital')),

-- Enterprise AI Breakfast (12)
(12, (SELECT id FROM event_categories WHERE name = 'Enterprise AI')),
(12, (SELECT id FROM event_categories WHERE name = 'Sales & Marketing')),

-- Physical AI (13)
(13, (SELECT id FROM event_categories WHERE name = 'Robotics')),
(13, (SELECT id FROM event_categories WHERE name = 'Computer Vision')),
(13, (SELECT id FROM event_categories WHERE name = 'Edge Computing')),

-- Web3 AI (14)
(14, (SELECT id FROM event_categories WHERE name = 'Blockchain')),
(14, (SELECT id FROM event_categories WHERE name = 'Generative AI')),

-- Legal Tech Workshop (15)
(15, (SELECT id FROM event_categories WHERE name = 'Legal Tech')),
(15, (SELECT id FROM event_categories WHERE name = 'Natural Language Processing'));